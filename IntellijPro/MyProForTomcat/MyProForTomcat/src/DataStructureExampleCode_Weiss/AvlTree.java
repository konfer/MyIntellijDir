...
// boolean isEmpty( ) -->    true if empty; else false
...
public class AvlTree<AnyType extends Comparable<? super AnyType>>
{
	...
	public static void main(String[] args)
	{
		...
		if(t.findMin() != 2 || t.findMax() != NUMS - 2) System.out
				.println("FindMin or FindMax error!");

		for(int i = 2; i < NUMS; i += 2)
			if(!t.contains(i)) System.out.println("Find error1!");

		for(int i = 1; i < NUMS; i += 2)
		{
			if(t.contains(i)) System.out.println("Find error2!");
		}
	}
}
