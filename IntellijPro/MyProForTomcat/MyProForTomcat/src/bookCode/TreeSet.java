		...
		Cloneable, java.io.Serializable
{
	 ...
	 * and {@code e2} in the set. If the user attempts to add an element to the
	 * set that violates this constraint (for example, the user attempts to add
	 * a string element to a set whose elements are integers), the {@code add}
	...
	{
		return new TreeSet<E>(m.subMap(fromElement, fromInclusive, toElement,
				toInclusive));
	}
