...
public class InterruptingIdiom 
{
	public static void main(String[] args) throws Exception
	{
		...
		t.start();
		TimeUnit.MILLISECONDS.sleep(new Integer(s[0]));
		t.interrupt();
	}
} /*
   * Output: (Sample) NeedsCleanup 1 Sleeping NeedsCleanup 2 Calculating
   * Finished time-consuming operation Cleaning up 2 Cleaning up 1 NeedsCleanup
   * 1 Sleeping Cleaning up 1 Exiting via InterruptedException
   */// :~
