...
public class Utilities
{
   ...
   * five, six, Yo] reverse: [Yo, six, five, Four, three, Two, Yo] rotate:
   * [three, Two, Yo, Yo, six, five, Four] copy: [in, the, matrix, Yo, six,
   * five, Four] swap: [Four, the, matrix, Yo, six, five, in] shuffled: [six,
   * matrix, the, Four, Yo, five, in] fill: [pop, pop, pop, pop, pop, pop, pop]
   * frequency of 'pop': 7 dups: [snap, snap, snap] 'list' disjoint 'dups'?:
   * true arrayList: [snap, snap, snap]
   */// :~
