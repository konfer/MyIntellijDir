...
public class PostOffice
{
   ...
   * Delivery: YES, Address Scanability: YES3, Address Readability: YES1,
   * Address Address: OK1, Return address: OK5 Using general delivery for Mail 2
   ...
   * Returning Mail 3 to sender**** Mail 4, General Delivery: NO4, Address
   * Scanability: UNSCANNABLE, Address Readability: YES1, Address Address:
   * INCORRECT, Return address: OK2 Returning Mail 4 to sender**** Mail 5,
   * General Delivery: NO3, Address Scanability: YES1, Address Readability:
   * ILLEGIBLE, Address Address: OK4, Return address: OK2 Delivering Mail 5
   * automatically**** Mail 6, General Delivery: YES, Address Scanability: YES4,
   * Address Readability: ILLEGIBLE, Address Address: OK4, Return address: OK4
   * Using general delivery for Mail 6**** Mail 7, General Delivery: YES,
   * Address Scanability: YES3, Address Readability: YES4, Address Address: OK2,
   * Return address: MISSING Using general delivery for Mail 7**** Mail 8,
   * General Delivery: NO3, Address Scanability: YES1, Address Readability:
   * YES3, Address Address: INCORRECT, Return address: MISSING Mail 8 is a dead
   * letter**** Mail 9, General Delivery: NO1, Address Scanability: UNSCANNABLE,
