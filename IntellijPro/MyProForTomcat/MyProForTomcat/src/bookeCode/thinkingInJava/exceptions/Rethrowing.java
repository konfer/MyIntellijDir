...
public class Rethrowing
{
	...
	{  
		...
		{
			System.out.println("Inside m(),e.printStackTrace()");
			e.printStackTrace(System.out);
		}
	}
   ...
   * Rethrowing.g(Rethrowing.java:11) at Rethrowing.main(Rethrowing.java:29)
   * main: printStackTrace() java.lang.Exception: thrown from f() at
