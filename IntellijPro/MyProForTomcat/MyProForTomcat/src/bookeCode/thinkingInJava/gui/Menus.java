...
public class Menus extends JFrame
{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if(actionCommand.equals("Open"))
			{
				...
				for(String flavor : flavors)
					if(s.equals(flavor)) chosen = true;
				if( ! chosen) t.setText("Choose a flavor first!");
				else t.setText("Opening " + s + ". Mmm, mm!");
			}
		}
	}
	...
	class CMIL implements ItemListener
	{
		public void itemStateChanged(ItemEvent e)
		{
			...
			String actionCommand = target.getActionCommand();
			if(actionCommand.equals("Guard")) t.setText("Guard the Ice Cream! " + "Guarding is " + target.getState());
			else if(actionCommand.equals("Hide")) t.setText("Hide the Ice Cream! " + "Is it hidden? " + target.getState());
		}
	}
