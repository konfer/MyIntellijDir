...
public class MessageBoxes extends JFrame
{
	...
	private ActionListener al = new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if(id.equals("Alert")) JOptionPane.showMessageDialog(null,
					"There's a bug on you!", "Hey!", JOptionPane.ERROR_MESSAGE);
			else if(id.equals("Yes/No")) JOptionPane.showConfirmDialog(null,
			...
			else if(id.equals("Color"))
			{
				...
				if(sel != JOptionPane.CLOSED_OPTION) txt
						.setText("Color Selected: " + options[sel]);
			}
