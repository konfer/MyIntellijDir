...
// Testing class Class.
package bookeCode.thinkingInJava.typeinfo.toys;
...
public class ToyTest
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			c = Class.forName("bookeCode.thinkingInJava.typeinfo.toys.FancyToy");
		}
   ...
   * Canonical name : typeinfo.toys.Waterproof Class name: typeinfo.toys.Shoots
   * is interface? [true] Simple name: Shoots Canonical name :
   * typeinfo.toys.Shoots Class name: typeinfo.toys.Toy is interface? [false]
   * Simple name: Toy Canonical name : typeinfo.toys.Toy
   */// :~
